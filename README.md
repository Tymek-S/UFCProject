# UFC Project
## Description
This project uses a machine learning model to predict the winner of UFC fights based on historical fight and fighter data. The goal was primarily learning and personal development. Much of the initial code was generated with the help of AI, but I adapted and customized it to fit my dataset and better understand the modeling process. This project reflects my early steps into data science and machine learning.
